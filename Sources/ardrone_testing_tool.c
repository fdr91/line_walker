...
#define EXAMPLE_POST_STAGES 1
	...
	START_THREAD(control_prepare,params);
	START_THREAD(comm_control, params);
...
PROTO_THREAD_ROUTINE(comm_control, data);
PROTO_THREAD_ROUTINE(control_prepare, data);
...
BEGIN_THREAD_TABLE
    ...
    THREAD_TABLE_ENTRY(control_prepare, 20)
